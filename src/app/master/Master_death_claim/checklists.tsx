      ...
      {selectedRow && (
        <div style={{
          ...
          <div style={{
            ...
            {/* Modal Header */}
            <div style={{ padding: '24px 32px 12px', display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexShrink: 0 }}>
              <h3 style={{ margin: 0, fontSize: 20, fontWeight: 700, color: '#1e293b' }}>Checklist Details</h3>
              <button onClick={() => setSelectedRow(null)} style={{ background: 'none', border: 'none', cursor: 'pointer', fontSize: 24, color: '#64748b' }}>&times;</button>
            </div>
            ...
            <form onSubmit={(e) => handleSave(e, selectedRow.id)} style={{ display: 'flex', flexDirection: 'column', flex: 1, minHeight: 0 }}>
              ...
              <div style={{ padding: '24px 32px 32px', display: 'flex', gap: 16, flexShrink: 0 }}>
                <button type="button" onClick={() => setSelectedRow(null)}
                  style={{ flex: 1, padding: '12px', borderRadius: 10, border: '1px solid #e2e8f0', background: '#fff', fontSize: 14, fontWeight: 600, color: '#1e293b', cursor: 'pointer' }}>Cancel</button>
                <button type="submit"
                  style={{ flex: 1, padding: '12px', borderRadius: 10, border: 'none', background: '#93c5fd', color: '#fff', fontSize: 14, fontWeight: 700, cursor: 'pointer', boxShadow: '0 4px 6px -1px rgba(147,197,253,0.5)' }}>Update Record</button>
              </div>
            </form>
          </div>
        </div>
      ...
      {showAddModal && (
        <div style={{
          ...
          <div style={{
            ...
            {/* Modal Header */}
            <div style={{ padding: '24px 32px 12px', display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexShrink: 0 }}>
              <h3 style={{ margin: 0, fontSize: 20, fontWeight: 700, color: '#1e293b' }}>Add New Checklist</h3>
              <button onClick={() => setShowAddModal(false)} style={{ background: 'none', border: 'none', cursor: 'pointer', fontSize: 24, color: '#64748b' }}>&times;</button>
            </div>
            ...
            <form onSubmit={(e) => handleSave(e)} style={{ display: 'flex', flexDirection: 'column', flex: 1, minHeight: 0 }}>
              ...
              <div style={{ padding: '24px 32px 32px', display: 'flex', gap: 16, flexShrink: 0 }}>
                <button type="button" onClick={() => setShowAddModal(false)}
                  style={{ flex: 1, padding: '12px', borderRadius: 10, border: '1px solid #e2e8f0', background: '#fff', fontSize: 14, fontWeight: 600, color: '#1e293b', cursor: 'pointer' }}>Cancel</button>
                <button type="submit"
                  style={{ flex: 1, padding: '12px', borderRadius: 10, border: 'none', background: '#93c5fd', color: '#fff', fontSize: 14, fontWeight: 700, cursor: 'pointer', boxShadow: '0 4px 6px -1px rgba(147,197,253,0.5)' }}>Save Checklist</button>
              </div>
            </form>
          </div>
        </div>
